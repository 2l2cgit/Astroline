...
public class RotationUtil {
    ...
    public static float[] getRotation(Entity a1) {
        ...
        return new float[]{RotationUtil.mc.thePlayer.rotationYaw + MathHelper.wrapAngleTo180_float(v9 - RotationUtil.mc.thePlayer.rotationYaw), RotationUtil.mc.thePlayer.rotationPitch + MathHelper.wrapAngleTo180_float(v10 - RotationUtil.mc.thePlayer.rotationPitch)};
    }
    ...
    public static float[] getFacingRotations2(int paramInt1, double d, int paramInt3) {
        ...
        return RotationUtil.getRotationsNeeded(localEntityPig);
    }
    ...
    public static float[] getRotations(double x, double y, double z, EnumFacing facing) {
        EntityPig temp = new EntityPig(RotationUtil.mc.theWorld);
        temp.posX = x + 0.5;
        temp.posY = y + 0.5;
        temp.posZ = z + 0.5;
        ...
        return RotationUtil.getRotations(temp);
    }
