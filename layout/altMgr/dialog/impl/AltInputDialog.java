...
import vip.astroline.client.layout.altMgr.CustomEmailField;
...
extends DialogWindow {
    ...
    public AltInputDialog(float x, float y, float width, float height, String title, String inputBoxText, String displayMsg, String acceptButtonText, String denyButtonText) {
        ...
        this.cef = new CustomEmailField(0, Minecraft.getMinecraft().fontRendererObj, (int)x, (int)y, (int)width - 6, 20);
        this.cef.setMaxStringLength(65535);
        this.cef.setText(inputBoxText);
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        this.cef.xPosition = (int)this.x + 3;
        this.cef.yPosition = (int)this.y + (int)this.height - 45;
        this.cef.drawTextBox();
    ...
    public void updateScreen() {
        this.cef.updateCursorCounter();
        super.updateScreen();
    }

    @Override
    public void keyTyped(char typedChar, int keyCode) {
        this.cef.textboxKeyTyped(typedChar, keyCode);
    ...
    public void mouseClick(int mouseX, int mouseY, int mouseButton) {
        ...
        this.cef.mouseClicked(mouseX, mouseY, mouseButton);
        if (mouseButton == 0) {
