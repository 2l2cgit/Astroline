...
extends Gui {
    ...
    public DialogTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                GuiRenderUtils.drawRoundedRect(this.xPosition, this.yPosition, this.width, this.height, 2.0f, -12231829, 1.0f, Hud.hudColor1.getColorInt());
            }
