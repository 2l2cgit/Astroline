...
extends Gui {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                GuiRenderUtils.drawRoundedRect(this.xPosition, this.yPosition, this.width, this.height, 2.0f, -12231829, 1.0f, -12231829);
            }
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        var6.pos(p_146188_1_, p_146188_4_, 0.0);
        var6.pos(p_146188_3_, p_146188_4_, 0.0);
        var6.pos(p_146188_3_, p_146188_2_, 0.0);
        var6.pos(p_146188_1_, p_146188_2_, 0.0);
        var7.draw();
