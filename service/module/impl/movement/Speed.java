...
extends Module {
    ...
    public void onUpdate(EventUpdate event) {
        ...
        } else if (!Speed.mc.thePlayer.onGround && (Speed.mc.gameSettings.keyBindRight.pressed || Speed.mc.gameSettings.keyBindLeft.pressed || Speed.mc.gameSettings.keyBindForward.pressed || Speed.mc.gameSettings.keyBindBack.pressed)) {
    ...
    public void onMove(EventMove event) {
        if (Speed.mc.gameSettings.keyBindRight.pressed || Speed.mc.gameSettings.keyBindLeft.pressed || Speed.mc.gameSettings.keyBindForward.pressed || Speed.mc.gameSettings.keyBindBack.pressed) {
